...
## 주요 개선 목표 (Objectives)
- **Legacy Migration:** 노후화된 파워빌더 시스템 → Python Flask 웹 애플리케이션으로 전환 시도.
- **Automation:** 수동 거리 계산 방식을 Kakao Mobility API 연동으로 자동화하여 정확도 및 효율성 80% 이상 향상.
- **UX Improvement:** 복잡한 UI를 직관적인 웹 인터페이스로 개선하여 사용자 경험 강화.
